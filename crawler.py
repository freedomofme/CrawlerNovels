...
if __name__ == '__main__':
    link_crawler('http://m.boluoxs.com/top/allvisit_1/', '/allvisit', delay=5, num_retries=1, user_agent='Mozilla/5.0(iPad; U; CPU OS 3_2_1 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko)Mobile')
